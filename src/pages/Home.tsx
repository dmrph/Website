...
const Home: React.FC = () => {
  // Data from resume
  const summary =
    "Software Developer with expertise in Python, Java, and C++. Passionate about building innovative solutions and solving complex problems.";
  ...
  const projects = [
    {
      ...
      description:
        "Contributed to a real-time swarm system using TurtleBots and Raspberry Pi for military-style search and rescue operations.",
      technologies: [
        "Python",
        "ROS 2 Jazzy",
        "LiDAR",
    ...
    },
    {
      ...
      description:
        "An interactive 3D globe visualization to explore global internet usage statistics by country and continent. Built with Three.js and GSAP, featuring real-time data from the World Bank.",
    ...
    },
    {
      title: "DecibelDetect",
      description:
        "Designed a web platform that visualizes urban noise pollution using user-submitted decibel data with interactive noise heatmap and real-time data visualization.",
    ...
    },
    {
      title: "T5Summarize",
      description:
        "Fine-tuned and deployed a T5 model for summarizing news and long-form text, with a Streamlit demo allowing users to input text and receive AI-generated summaries.",
    ...
    },
    {
      ...
      description:
        "CMPSC 472 - Operating Systems - File Processing System. Program is meant to count frequency of a given word.",
      technologies: ["C"],
    ...
    },
    {
      title: "RoutePlanner",
      description:
        "Route planner for data structures class at Penn State University. Spring of 2024.",
      technologies: ["HTML"],
